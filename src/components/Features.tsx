      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-12">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-college-blue mb-6">
            ...
            <ul className="space-y-4">
              {features.map((feature, index) => (
                <li key={index} className="flex items-start">
                  <CheckCircle className="text-college-gold h-6 w-6 mr-3 flex-shrink-0 mt-0.5" />
          ...
          <div className="md:w-1/2">
            <div className="relative">
              <div className="absolute -left-4 -top-4 w-64 h-64 bg-college-blue/10 rounded-lg"></div>
              <img 
              ...
              />
              <div className="absolute -right-4 -bottom-4 w-48 h-48 bg-college-gold/20 rounded-lg"></div>
            </div>
          </div>
        </div>
      </div>
