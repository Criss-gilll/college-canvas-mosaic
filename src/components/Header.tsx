        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-3 text-xl font-serif font-bold text-college-blue">Evergreen University</span>
            </Link>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden pb-4">
            <div className="flex flex-col space-y-3">
              <Link to="/" className="text-gray-700 hover:text-college-blue py-2 font-medium">Home</Link>
              
              <button 
                onClick={toggleAcademicDropdown}
                className="text-gray-700 hover:text-college-blue py-2 font-medium flex items-center justify-between"
              >
                Academics <ChevronDown className={`ml-1 h-4 w-4 transform ${academicDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
              
              {academicDropdownOpen && (
                <div className="pl-4 flex flex-col space-y-2 border-l-2 border-gray-200">
                  <Link to="#" className="text-gray-600 hover:text-college-blue py-1">Undergraduate</Link>
                  <Link to="#" className="text-gray-600 hover:text-college-blue py-1">Graduate</Link>
                  <Link to="#" className="text-gray-600 hover:text-college-blue py-1">Departments</Link>
                  <Link to="#" className="text-gray-600 hover:text-college-blue py-1">Research</Link>
                </div>
              )}
              
              <Link to="#" className="text-gray-700 hover:text-college-blue py-2 font-medium">Campus Life</Link>
              <Link to="#" className="text-gray-700 hover:text-college-blue py-2 font-medium">Admission</Link>
              <Link to="#" className="text-gray-700 hover:text-college-blue py-2 font-medium">About</Link>
